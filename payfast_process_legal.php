...
// PayFast URLs
$return_url = "https://valueaddedhealthcaresa.com/success_legal.php"; // URL after successful payment
$cancel_url = "https://valueaddedhealthcaresa.com/cancel_legal.php"; // URL after canceled payment
$notify_url = "https://valueaddedhealthcaresa.com/notify_legal.php"; // PayFast notification URL (IPN)
...
$payfast_data = [
    ...
    'name_last' => $last_name,
    'email_address' => $email,
    'amount' => number_format($deposit_amount, 2, '.', ''), // Total price formatted to 2 decimals
